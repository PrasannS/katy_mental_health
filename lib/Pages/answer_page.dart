...
class _AnswerPageState extends State<AnswerPage> {
  ...
  List<String> questions = [
    ...
    "Question of the Day:",
    "What was your most impactful activity today?",
    "Any Notes for Today?",
    "Submit?"
  ];
  ...
  LinearGradient getGradient(int a) {
    return new LinearGradient(
        ...
        colors: [
          Color.fromRGBO(255 - ends[currentQuestion], 0, 50, 1.0),
